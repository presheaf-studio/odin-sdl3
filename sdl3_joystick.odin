...
VirtualJoystickDesc :: struct {
    ...
    Rumble:            proc "c" (
        userdata: rawptr,
        low_frequency_rumble, high_frequency_rumble: Uint16,
    ) -> bool, /**< Implements SDL_RumbleJoystick() */
    RumbleTriggers:    proc "c" (
        userdata: rawptr,
        left_rumble, right_rumble: Uint16,
    ) -> bool, /**< Implements SDL_RumbleJoystickTriggers() */
    SetLED:            proc "c" (
        userdata: rawptr,
        red, green, blue: Uint8,
    ) -> bool, /**< Implements SDL_SetJoystickLED() */
    SendEffect:        proc "c" (
        userdata: rawptr,
        data: rawptr,
        size: c.int,
    ) -> bool, /**< Implements SDL_SendJoystickEffect() */
    SetSensorsEnabled: proc "c" (
        userdata: rawptr,
        enabled: bool,
    ) -> bool, /**< Implements SDL_SetGamepadSensorEnabled() */
